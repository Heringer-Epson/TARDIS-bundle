...
class Input_Parameters(object):
    ...
    def __init__(self):     
        ...
        self.subdir = '05bl_correct-L/'
        self.filename_structure = '05bl_correct-L'
        ...
        Default
        """
        self.luminosity = ['7.23e8']#['3.35e8', '4.24e8', '5.68e8', '7.23e8', '3.93e8']
        self.time_explosion = ['21.8']#['11.0', '12.0', '14.0', '21.8', '29.9']
        self.velocity_start = ['6600']#['8400', '8100', '7500', '6600', '3300']
        
        """
        Used to luminosity variations at all epochs
        """
        #self.luminosity = [
        #  '3.35e8', '4.24e8', '5.68e8', '7.23e8', '3.93e8',
        #  '6.70e8', '8.48e8', '1.14e9', '1.45e9', '7.86e8',
        #  '1.01e9', '1.27e9', '1.70e9', '2.17e9', '1.02e9',
        #  '1.34e9', '1.70e9', '2.24e9', '2.89e9', '1.57e9'
        #  ]
        ...
        self.velocity_array = (list(np.logspace(np.log10(3050.),
                               np.log10(19000.), 100).astype(str)))
        ...
        VELOCITIES BETWEEN LAYERS BELOW WILL REFLECT THE ABUNDANCE OF LOWER VELOCITY.
        """            
        self.velocity_zones = ['3000',   '6600',   '7500',   '8100',   '8400',   '16000']
        
        self.abun_raw['H']  = ['0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000']
        self.abun_raw['He'] = ['0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000']
        self.abun_raw['Li'] = ['0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000']
        self.abun_raw['Be'] = ['0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000']
        self.abun_raw['B']  = ['0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000']
        self.abun_raw['C']  = ['0.0000', '0.0000', '0.0000', '0.0000', '0.0500', '0.4184']
        self.abun_raw['N']  = ['0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000']
        self.abun_raw['O']  = ['0.0000', '0.0000', '0.0100', '0.1700', '0.8431', '0.5726']
        self.abun_raw['F']  = ['0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000']
        self.abun_raw['Ne'] = ['0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000']
        self.abun_raw['Na'] = ['0.0000', '0.0000', '0.0000', '0.0013', '0.0025', '0.0000']
        self.abun_raw['Mg'] = ['0.0000', '0.0000', '0.0000', '0.0400', '0.0300', '0.0030']
        self.abun_raw['Al'] = ['0.0000', '0.0000', '0.0011', '0.0032', '0.0032', '0.0000']
        self.abun_raw['Si'] = ['0.6447', '0.6947', '0.6886', '0.6477', '0.0500', '0.0050']
        self.abun_raw['P']  = ['0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000']
        self.abun_raw['S']  = ['0.0000', '0.0600', '0.1200', '0.1000', '0.0200', '0.0010']
        self.abun_raw['Cl'] = ['0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000']
        self.abun_raw['Ar'] = ['0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000']
        self.abun_raw['K']  = ['0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000']
        self.abun_raw['Ca'] = ['0.0003', '0.0003', '0.0003', '0.0003', '0.0003', '0.0000']
        self.abun_raw['Sc'] = ['0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000']
        self.abun_raw['Ti'] = ['0.0350', '0.0675', '0.0500', '0.0100', '0.0004', '0.0000']
        self.abun_raw['V']  = ['0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000']
        self.abun_raw['Cr'] = ['0.0350', '0.0675', '0.0500', '0.0100', '0.0004', '0.0000']
        self.abun_raw['Mn'] = ['0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000']
        self.abun_raw['Fe'] = ['0.0950', '0.1000', '0.0800', '0.0175', '0.0001', '0.0000']
        self.abun_raw['Co'] = ['0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000']
        self.abun_raw['Ni'] = ['0.1900', '0.0100', '0.0000', '0.0000', '0.0000', '0.0000']
        self.abun_raw['Cu'] = ['0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000']
        self.abun_raw['Zn'] = ['0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000']
